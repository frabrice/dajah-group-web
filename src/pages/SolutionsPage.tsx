        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-blue-500/10 backdrop-blur-sm border border-blue-500/20 rounded-full px-6 py-3 mb-8">
              ...
              <span className="text-blue-500 font-medium">Our Solutions</span>
            </div>

            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              A <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600">360-Degree Solution</span> for Creators
            </h1>
      ...
      <section className="py-24 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-3xl p-12 md:p-16 hover:border-blue-500/50 transition-all duration-300"
          >
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <div className="bg-blue-500/10 w-20 h-20 rounded-xl flex items-center justify-center mb-8">
      ...
      <section className="py-24 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="bg-gradient-to-br from-black to-gray-900 border border-gray-800 rounded-3xl p-12 md:p-16 hover:border-blue-500/50 transition-all duration-300"
          >
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 md:order-2">
                <div className="bg-blue-500/10 w-20 h-20 rounded-xl flex items-center justify-center mb-8">
                  <FileMusic className="h-10 w-10 text-blue-500" />
                </div>
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                  Sync & Licensing
                </h2>
      ...
      <section className="py-24 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="bg-gradient-to-br from-gray-900 to-black border-2 border-blue-500/30 rounded-3xl p-12 md:p-16"
          >
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <div className="bg-blue-500/10 w-20 h-20 rounded-xl flex items-center justify-center mb-8">
                ...
                <a
                  ...
                  className="inline-flex items-center px-8 py-4 bg-blue-500 text-black font-semibold rounded-lg hover:bg-blue-400 transition-all duration-300 transform hover:-translate-y-1"
                >
              ...
              <div className="space-y-4">
                {distroFeatures.map((feature, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.6, delay: index * 0.1 }}
                    className="flex items-start space-x-4 bg-black/50 border border-blue-500/30 rounded-lg p-4"
                  >
                    <CheckCircle className="h-6 w-6 text-blue-500 flex-shrink-0 mt-1" />
                    <span className="text-gray-300">{feature}</span>
                  </motion.div>
