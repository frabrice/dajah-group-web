    ...
    <div className="min-h-screen bg-black">
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-yellow-600 rounded-full filter blur-3xl animate-pulse delay-1000"></div>
        </div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/solutions"
                onClick={scrollToTop}
                className="inline-flex items-center px-8 py-4 bg-yellow-500 text-black font-semibold rounded-lg hover:bg-yellow-400 transition-all duration-300 transform hover:-translate-y-1"
              >
                Get Started
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
          <div className="flex space-x-1">
            <div className="w-1 h-8 bg-yellow-500 animate-pulse"></div>
            <div className="w-1 h-12 bg-yellow-500 animate-pulse delay-100"></div>
            <div className="w-1 h-6 bg-yellow-500 animate-pulse delay-200"></div>
            <div className="w-1 h-10 bg-yellow-500 animate-pulse delay-300"></div>
            <div className="w-1 h-8 bg-yellow-500 animate-pulse delay-400"></div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="bg-black border border-gray-800 rounded-xl p-8 hover:border-yellow-500/50 transition-all duration-300 group"
              >
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <motion.div
                ...
                className="border-l-2 border-yellow-500 pl-6 text-left"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <Link
              to="/contact"
              onClick={scrollToTop}
              className="inline-flex items-center px-8 py-4 bg-black text-yellow-500 font-semibold rounded-lg hover:bg-gray-900 transition-all duration-300 transform hover:-translate-y-1"
            >
              Get Started Today
              <ArrowRight className="ml-2 h-5 w-5" />
            </Link>
