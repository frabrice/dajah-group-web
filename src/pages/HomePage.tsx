    ...
    <div className="min-h-screen bg-black">
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-teal-600 rounded-full filter blur-3xl animate-pulse delay-1000"></div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-teal-500/10 backdrop-blur-sm border border-teal-500/20 rounded-full px-6 py-3 mb-8">
              ...
              <span className="text-teal-500 font-medium">The Future of Music Rights</span>
            </div>
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
          <div className="flex space-x-1">
            <div className="w-1 h-8 bg-teal-500 animate-pulse"></div>
            <div className="w-1 h-12 bg-teal-500 animate-pulse delay-100"></div>
            <div className="w-1 h-6 bg-teal-500 animate-pulse delay-200"></div>
            <div className="w-1 h-10 bg-teal-500 animate-pulse delay-300"></div>
            <div className="w-1 h-8 bg-teal-500 animate-pulse delay-400"></div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="bg-gradient-to-r from-teal-500/10 to-teal-600/10 border border-teal-500/20 rounded-2xl p-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="bg-black border border-gray-800 rounded-xl p-8 hover:border-teal-500/50 transition-all duration-300 group"
              >
                <div className="bg-teal-500/10 w-16 h-16 rounded-lg flex items-center justify-center mb-6 group-hover:bg-teal-500/20 transition-colors">
                ...
                <Link
                  to="/solutions"
                  onClick={scrollToTop}
                  className="inline-flex items-center text-teal-500 hover:text-teal-400 transition-colors font-medium"
                >
                  Learn More
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <motion.div
                ...
                className="border-l-2 border-teal-500 pl-6 text-left"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <Link
              to="/contact"
              onClick={scrollToTop}
              className="inline-flex items-center px-8 py-4 bg-black text-teal-500 font-semibold rounded-lg hover:bg-gray-900 transition-all duration-300 transform hover:-translate-y-1"
            >
              Get Started Today
              <ArrowRight className="ml-2 h-5 w-5" />
            </Link>
