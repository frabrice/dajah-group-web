      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-blue-500/10 backdrop-blur-sm border border-blue-500/20 rounded-full px-6 py-3 mb-8">
              ...
              <span className="text-blue-500 font-medium">The Future of Music Rights</span>
            </div>
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
          <div className="flex space-x-1">
            ...
            <div className="w-1 h-12 bg-blue-500 animate-pulse delay-100"></div>
            <div className="w-1 h-6 bg-blue-500 animate-pulse delay-200"></div>
            <div className="w-1 h-10 bg-blue-500 animate-pulse delay-300"></div>
            <div className="w-1 h-8 bg-blue-500 animate-pulse delay-400"></div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="bg-black border border-gray-800 rounded-xl p-8 hover:border-blue-500/50 transition-all duration-300 group"
              >
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <motion.div
                ...
                className="border-l-2 border-blue-500 pl-6 text-left"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <Link
              to="/contact"
              onClick={scrollToTop}
              className="inline-flex items-center px-8 py-4 bg-black text-blue-500 font-semibold rounded-lg hover:bg-gray-900 transition-all duration-300 transform hover:-translate-y-1"
            >
              Get Started Today
              <ArrowRight className="ml-2 h-5 w-5" />
            </Link>
