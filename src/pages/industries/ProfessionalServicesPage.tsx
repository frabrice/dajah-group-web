...
import { ArrowRight, GraduationCap, Calculator, FileCheck, Building2, Users, Brain, LineChart } from 'lucide-react';
  ...
  const mainServices = [
    {
      icon: Calculator,
      title: "Tax Planning",
      description: "Proactive tax planning and compliance services for both corporate and individual professionals."
    },
    {
      icon: FileCheck,
      title: "Assurance Services",
      description: "Comprehensive audit and assurance services tailored for professional service firms."
    },
    {
      icon: Building2,
  ...
  const specializedServices = [
    {
      ...
      description: "Expert guidance on managing and growing professional service practices."
    },
    {
      icon: Brain,
      title: "Strategic Planning",
      description: "Long-term strategic planning and development for professional firms."
    },
    {
      icon: LineChart,
      ...
      <div className="relative bg-black text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <div className="max-w-3xl">
            <h1 className="text-5xl font-bold mb-6 font-playfair">Professional Services Expertise</h1>
            <p className="text-xl text-white/90 leading-relaxed">
              Being in the professional services industry ourselves, we understand that time is money and that you would rather spend that time servicing your clients.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="prose prose-lg max-w-none mb-16">
          <p className="text-lg text-military-700 leading-relaxed">
            Dajah Group supports clients in the architectural, business outsourcing, engineering, legal, management solutions, medical industries, as well as professional employee organizations and a wide range of additional service providers. We can provide as much or as little support as needed, depending on each client's specific needs and internal resources.
          </p>
        </div>
      ...
      <div className="bg-gradient-to-br from-military-900 via-military-800 to-military-900 py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            ...
            <h2 className="text-4xl font-bold text-white mb-6 font-playfair">Ready to Elevate Your Professional Practice?</h2>
            <p className="text-xl text-military-100 mb-8 max-w-3xl mx-auto leading-relaxed">
              Excellence recognizes excellence. Let our professional services experts free you from financial complexities, so you can focus on delivering exceptional value to your clients and growing your practice.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <span className="text-military-200 text-sm">Professional excellence, amplified</span>
            </div>
          </div>
        </div>
      </div>
