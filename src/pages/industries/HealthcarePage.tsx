...
import { ArrowRight, Stethoscope, FileCheck, Calculator, Building2, Brain, BarChart as ChartBar } from 'lucide-react';
  ...
  const mainServices = [
    {
      ...
      description: "Strategic planning and organizational development services tailored for healthcare institutions."
    },
    {
      icon: Calculator,
      title: "Financial Management",
      description: "Comprehensive financial services including audits, reviews, and compilations of financial statements."
    }
  ];
  ...
  const specializedServices = [
    {
      ...
      description: "Long-term strategic planning and organizational development for healthcare organizations."
    },
    {
      icon: FileCheck,
      title: "Compliance Services",
      description: "Ensuring adherence to complex healthcare regulations and oversight requirements."
    },
    {
      icon: ChartBar,
      title: "Performance Analysis",
      description: "Detailed analysis and optimization of financial and operational performance."
    }
  ];

  const additionalServices = [
    "Collaboration analysis and feasibility studies",
      ...
      <div className="relative bg-black text-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <div className="max-w-3xl">
            <h1 className="text-5xl font-bold mb-6 font-playfair">Healthcare Industry Expertise</h1>
            <p className="text-xl text-white/90 leading-relaxed">
              We understand the challenge of managing in an environment of increasingly complex regulation and oversight. Our expertise helps you navigate these challenges while maintaining excellent patient care.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="prose prose-lg max-w-none mb-16">
          <p className="text-lg text-military-700 leading-relaxed">
            The Dajah Group team knows the long-term healthcare industry, both not-for-profit and for-profit. We will gain an understanding of your organization and work with you to achieve your goals while maintaining compliance and operational excellence.
          </p>
        </div>
      ...
      <div className="bg-gradient-to-br from-military-900 via-military-800 to-military-900 py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center">
            ...
            <h2 className="text-4xl font-bold text-white mb-6 font-playfair">Ready to Heal Your Financial Health?</h2>
            <p className="text-xl text-military-100 mb-8 max-w-3xl mx-auto leading-relaxed">
              Your mission to heal deserves financial wellness. Let our healthcare specialists provide the expert care your organization needs to thrive while you focus on what matters most - your patients.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <span className="text-military-200 text-sm">Prescription for financial success</span>
            </div>
          </div>
        </div>
      </div>
