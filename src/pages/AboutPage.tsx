        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-blue-500/10 backdrop-blur-sm border border-blue-500/20 rounded-full px-6 py-3 mb-8">
              ...
              <span className="text-blue-500 font-medium">About Dajah Group</span>
            </div>

            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Redefining Music <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600">Administration</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-gradient-to-br from-blue-500/20 to-blue-600/20 border border-blue-500/30 rounded-2xl p-8">
                <div className="space-y-6">
                  {milestones.map((milestone, index) => (
                    <div key={index} className="flex items-start space-x-4">
                      <div className="flex-shrink-0 w-20">
                        <div className="text-3xl font-bold text-blue-500">{milestone.year}</div>
                      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            <motion.div
              ...
              className="bg-black border border-gray-800 rounded-2xl p-8 hover:border-blue-500/50 transition-all duration-300"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="bg-gradient-to-b from-gray-900 to-black border border-gray-800 rounded-2xl overflow-hidden hover:border-blue-500/50 transition-all duration-300"
            >
              <div className="aspect-square bg-gradient-to-br from-blue-500/20 to-transparent"></div>
              <div className="p-8">
                <h3 className="text-xl font-bold text-white mb-2">Muvunyi</h3>
                <p className="text-blue-500 font-medium mb-4">CEO & Founder</p>
            ...
            >
              ...
              <div className="p-8">
                ...
                <p className="text-blue-500 font-medium mb-4">Head of Publishing Administration</p>
                <p className="text-gray-400 leading-relaxed">
            ...
            >
              ...
              <div className="p-8">
                ...
                <p className="text-blue-500 font-medium mb-4">VP of Distribution (DajahTunes)</p>
                <p className="text-gray-400 leading-relaxed">
            ...
            >
              ...
              <div className="p-8">
                ...
                <p className="text-blue-500 font-medium mb-4">Global Licensing Director</p>
                <p className="text-gray-400 leading-relaxed">
