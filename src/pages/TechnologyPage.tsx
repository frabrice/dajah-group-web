    ...
    <div className="min-h-screen bg-black pt-16">
      <section className="relative bg-gradient-to-b from-gray-900 to-black text-white py-24 overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-1/3 left-1/3 w-96 h-96 bg-purple-500 rounded-full filter blur-3xl animate-pulse"></div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-purple-500/10 backdrop-blur-sm border border-purple-500/20 rounded-full px-6 py-3 mb-8">
              ...
              <span className="text-purple-500 font-medium">Technology & Reach</span>
            </div>

            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Smart Technology. <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-600">Global Reach.</span>
            </h1>
      ...
      <section className="py-24 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="bg-gradient-to-br from-black to-gray-900 border-2 border-purple-500/30 rounded-3xl p-12 md:p-16"
          >
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-black/50 border border-gray-800 rounded-2xl p-8">
                <div className="text-center mb-6">
                  <div className="text-7xl font-bold text-purple-500 mb-4">120+</div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <Link
                to="/solutions"
                onClick={scrollToTop}
                className="inline-flex items-center px-8 py-4 bg-purple-500 text-black font-semibold rounded-lg hover:bg-purple-400 transition-all duration-300"
              >
            ...
            >
              {[
                ...
                <div key={index} className="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-purple-500/50 transition-all duration-300">
